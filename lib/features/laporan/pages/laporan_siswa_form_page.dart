...
import '../../../core/utils/juz_map.dart'; // kalau perlu normSurah
...
class _LaporanSiswaFormPageState extends ConsumerState<LaporanSiswaFormPage> {
  ...
  Widget jsaFields(
    ...
    return StatefulBuilder(
      builder: (context, setInner) {
        ...
        // kalau surahKeyVal tidak ada dalam juz terpilih, reset
        if (juzVal != null &&
            surahKeyVal != null &&
        ...
        return Column(
          ...
          children: [
            ...
            DropdownButtonFormField<int>(
              ...
              validator: (v) {
                // kalau user belum pilih apa-apa dan field ini dipakai
            ...
            DropdownButtonFormField<String>(
              ...
              validator: (v) {
                // jika juz belum dipilih, jangan paksa surah
            ...
            TextFormField(
              ...
              keyboardType: TextInputType
                  .text, // biar "-" gampang (kalau number kadang susah)
              autovalidateMode: AutovalidateMode.onUserInteraction,
              decoration: const InputDecoration(
                labelText: 'Ayat',
              ...
              validator: (_) {
                ...
                // format yang diterima: "7" atau "1-7"
                ...
                // kedua ujung range harus masih dalam segment juz tsb
  ...
  Widget _oneField(String label, TextEditingController c) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
