...
class KelasListGuruPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<KelasListGuruPage> createState() => _KelasListGuruPageState();
}

class _KelasListGuruPageState extends ConsumerState<KelasListGuruPage> {
  ...
  Widget build(BuildContext context) {
    final kelasAsync = ref.watch(kelasGuruListProvider);
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => ref.read(kelasGuruListProvider.notifier).refresh(),
          ),
        ],
      ),
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, i) {
                    ...
                    return KelasTile(
                      ...
                      onToggleAktif: () async {
                        await ref
                            .read(kelasGuruListProvider.notifier)
                            .toggleAktif(s);
                      },
                      onDelete: () async {
