...
class KelasListSiswaPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<KelasListSiswaPage> createState() => _KelasListSiswaPageState();
}

class _KelasListSiswaPageState extends ConsumerState<KelasListSiswaPage> {
  ...
  Widget build(BuildContext context) {
    final kelasAsync = ref.watch(kelasSiswaListProvider);
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () =>
                ref.read(kelasSiswaListProvider.notifier).refresh(),
          ),
        ],
      ),
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          final ok = await Navigator.push<bool>(
            context,
            MaterialPageRoute(builder: (_) => const GabungKelasPage()),
          );
                    ...
                    return KelasSiswaTile(
                      ...
                      onTap: () async {
                        ...
                        final ok = await Navigator.push<bool>(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                LaporanListPage(existing: siswa,existingKelas: s),
                          ),
                        );
                        if (ok == true && context.mounted) {
                          ref.read(kelasSiswaListProvider.notifier).refresh();
                      ...
                      onDetail: () async {
                        final ok = await Navigator.push<bool>(
                          context,
                          MaterialPageRoute(
                            builder: (_) => DetailKelasSiswaPage(existing: s),
                          ),
                        );
                        if (ok == true && context.mounted) {
